  ...
  return (
    <div>
      ...
      <Container className="mt-4 mb-5" style={{ maxWidth: 800 }}>
        ...
        <p>Bem-vindo ao website Wilboor.com.br, onde todos os serviços são ofertados por meio da pessoa física Marcos Rogério Guerreiro, inscrito sob o CPF n° 162.033.768/17, e RG nº 19.668.814, endereço eletrônico marcosguerreiro@hotmail.com, com endereço para receber notificações na Rua Geraldo Pecorari, 838, Centro, Macatuba, SP, CEP 17290043, representado nessa página eletrônica. Avisamos previamente que ao acessar esse site você concorda tacitamente com as disposições contidas nesse documento, por isso muito atenção ao ler cada uma das cláusulas e obrigações dispostas a seguir:</p>
        ...
        <p>4.0 Das obrigações do proprietário do e-commerce </p>
        ...
        <p>7.5 Se o cliente quiser parcelar o produto em mais vezes deverá arcar com os juros da operadora.B</p>
        <p>Para solicitar o estorno entre em contato com a nossa Central de Atendimento ou SAC.</p>
